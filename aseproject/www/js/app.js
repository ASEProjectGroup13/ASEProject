...
var myapp = angular.module('aseproject', ['ionic','ngCordova'])
  ...
  .config(function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
      ...
      .state('profile.plannedCourses', {
        url: "/profilePlannedCourses",
        views: {
          'appContent' :{
      ...
      .state('profile.recommendedcourses', {
        url: "/profileRecommendedCourses",
        views: {
          'appContent' :{
            templateUrl: "templates/CourseRecommendation.html",
            controller:"RecommendCoursesPageCtrl"
    ...
    /***
     * Ratings related routers
     */

      .state('studentcoursedetails',{
        url: '/studentcoursedetails',
        templateUrl: 'templates/studentCourseDetails.html',
        controller: "StudentCourseDetailsCtrl"
      })
    ...
    /***
     * Routes related to professors
     */
      //.state('professorsmainpage',{
      //  url: '/professorsmainpage',
      //  templateUrl: 'templates/professorsmainpage.html'
      //  //controller: "StudentCourseDetailsCtrl"
      //})

    /***
     *  Routes related to main page
     */
      .state('profhomepage.profprofile', {
        url: '/profprofile',
        views: {
          'profprofessor': {
            templateUrl: 'templates/profprofessors.html',
            controller: 'ProfProfileCtrl'
          }
        }
      })
     .state('profhomepage.profcoursespage', {
        url: '/profcoursespage',
        views: {
          'profcourses': {
            templateUrl: 'templates/profcoursesPage.html',
            controller: 'ProfCoursesPageCtrl'
          }
        }
      })
      .state('profhomepage.profprofileupdate', {
        url: '/profprofileupdate',
        views: {
          'profupdate': {
            templateUrl: 'templates/profprofileupdate.html',
            controller: 'ProfProfileUpdateCtrl'
          }
        }
      })
     //.state('profhomepage.profprofilePage', {
     //   url: '/profilePage',
     //   views: {
     //     'profile': {
     //       templateUrl: 'templates/profprofilePage.html',
     //       controller: 'ProfilePageCtrl'
     //     }
     //   }
     // })
